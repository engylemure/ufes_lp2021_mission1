...
export class InterfaceDrawComponent implements IComponent {
    ...
    private snakeSpeedSandboxElm(): HTMLButtonElement {
        ...
        button.onclick = () => Settings.changeSnakeSpeed(SNAKE_SPEED_DIFFICULTY.SANDBOX)
        return button
    }
    ...
    private snakeSpeedEasyElm(): HTMLButtonElement {
        ...
        button.onclick = () => Settings.changeSnakeSpeed(SNAKE_SPEED_DIFFICULTY.EASY)
        return button  
    }
    ...
    private snakeSpeedNormalElm(): HTMLButtonElement {
        ...
        button.onclick = () => Settings.changeSnakeSpeed(SNAKE_SPEED_DIFFICULTY.NORMAL)
        return button 
    }
    ...
    private snakeSpeedHardElm(): HTMLButtonElement {
        ...
        button.onclick = () => Settings.changeSnakeSpeed(SNAKE_SPEED_DIFFICULTY.HARD)
        return button 
    }
    ...
    public Update(deltaTime: number): void {
        ...
        this._snakeSpeedSandboxElm.disabled = Settings.snakeSpeed === SNAKE_SPEED_DIFFICULTY.SANDBOX
        this._snakeSpeedEasyElm.disabled = Settings.snakeSpeed === SNAKE_SPEED_DIFFICULTY.EASY
        this._snakeSpeedNormalElm.disabled = Settings.snakeSpeed === SNAKE_SPEED_DIFFICULTY.NORMAL
        this._snakeSpeedHardElm.disabled = Settings.snakeSpeed === SNAKE_SPEED_DIFFICULTY.HARD
    }
